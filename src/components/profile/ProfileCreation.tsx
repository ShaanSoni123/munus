...
export const ProfileCreation: React.FC<ProfileCreationProps> = ({ onComplete, onBack }) => {
  ...
  const renderRoleSelection = () => (
    <div className="space-y-6">
      ...
      {/* Google Sign-in Button - Only show after role selection */}
        ...
        <div className="mt-8 text-center">
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full flex items-center justify-center px-6 py-3 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
            >
            ...
            <button
              ...
              disabled={isSubmitting}
              className="w-full flex items-center justify-center px-6 py-3 border border-emerald-500 dark:border-emerald-400 rounded-lg shadow-sm bg-emerald-500 dark:bg-emerald-600 text-white hover:bg-emerald-600 dark:hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
            >
